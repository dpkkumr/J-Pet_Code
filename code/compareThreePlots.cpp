...
// 	c1->SetWindowSize(1100, 1100);
    ...
    TH1D *frame = new TH1D("frame","frame", 160 , -800 , 0 );
    ...
    TH1D *frame2 = new TH1D("frame2","frame2", 160 , -800 , 0 );
    ...
    TH1D *frame3 = new TH1D("frame3","frame3", 160 , -800 , 0 );
	...
	dataTree_Right->Draw("Amplitude1 >> frame3","","");
    ...
    legend->AddEntry(frame3,filePath_Right.c_str(),"l");
...
// 	c1->SetWindowSize(1100, 1100);
    ...
    frame3 = new TH1D("frame3","frame3", 160 , -800 , 0 );
	frame3->GetXaxis()->SetTitle("Amplitude [mV]");
	frame3->GetYaxis()->SetTitle("Counts");
	...
	dataTree_Right->Draw("Amplitude2 >> frame3","","same");
...
// 	c1->SetWindowSize(1100, 1100);
	...
	dataTree_Right->Draw("Charge2 >> frame3","","same");
...
// 	c1->SetWindowSize(1100, 1100);
	...
	dataTree_Right->Draw("Charge1 >> frame3","","");
...
// 	c1->SetWindowSize(1100, 1100);
    ...
    dataTree_Left->Draw("TimeAtThr1 - TimeAtThr2 >> frame","","");
	dataTree_Center->Draw("TimeAtThr1 - TimeAtThr2 >> frame2","","same");
